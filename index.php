...
<body>
                  ...
                  include_once (dirname(__FILE__)).'/./functions/Form_create.php';
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <span class="error"> <?php echo $name_error;?></span>
                    ...
                    <div class="col-12">
                      <label for="yourName" class="form-label">Your TEDx Event Name</label>
                      <input type="text" name="tedx_name" class="form-control" id="youreventName" required>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Required field. Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters.</div>
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label"> Confirm Password</label>
                      <input type="password" name="confpassword" class="form-control" id="yourPassword"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
                      <div class="invalid-feedback">Required field. Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters.</div>
                    </div>
